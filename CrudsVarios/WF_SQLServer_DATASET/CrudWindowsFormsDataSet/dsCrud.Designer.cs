...
namespace CrudWindowsFormsDataSet.dsCrudTableAdapters {
    ...
    public partial class peopleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [people] WHERE (([id] = @Original_id) AND ([name] = @Original_name) A" +
                "ND ([age] = @Original_age))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [people] ([name], [age]) VALUES (@name, @age);\r\nSELECT id, name, age " +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [people] SET [name] = @name, [age] = @age WHERE (([id] = @Original_id) AND" +
                " ([name] = @Original_name) AND ([age] = @Original_age));\r\nSELECT id, name, age F" +
                "ROM people WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "select * from people";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "insert into people(name, age)\r\nvalues (@name, @age)";
            ...
            this._commandCollection[2].CommandText = "UPDATE people set name=@name,age=@age where id=@id";
            ...
            this._commandCollection[3].CommandText = "select * from people\r\nwhere id=@id";
            ...
            this._commandCollection[4].CommandText = "DELETE FROM people where id= @id";
        ...
        public virtual int Fill(dsCrud.peopleDataTable dataTable) {
        ...
        public virtual dsCrud.peopleDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsCrud.peopleDataTable dataTable = new dsCrud.peopleDataTable();
        ...
        public virtual int FillBy(dsCrud.peopleDataTable dataTable, int id) {
        ...
        public virtual dsCrud.peopleDataTable GetDataById(int id) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(id));
            dsCrud.peopleDataTable dataTable = new dsCrud.peopleDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsCrud.peopleDataTable dataTable) {
        ...
        public virtual int Add(string name, int age) {
        ...
        public virtual int Edit(string name, int age, int id) {
